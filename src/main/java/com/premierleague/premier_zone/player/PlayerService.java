...
public class PlayerService {
    ...
    public List<Player> getPlayerByPositions(String searchText) {
    ...
    public List<Player> getPlayersByTeamAndPosition(String team, String position) {
        return playerRepository.findAll().stream().filter(player -> player.getTeam().equals(team) && player.getPosition().equals(position)).collect(Collectors.toList());
    }
    ...
    public void deletePlayer(String playerName) {
        playerRepository.deteleByName(playerName);
    }
